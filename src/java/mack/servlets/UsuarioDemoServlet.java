...
public class UsuarioDemoServlet extends HttpServlet {

    static final private Log log = LogFactory.getLog(UsuarioDemoServlet.class);
    ...
    public void setupDemo() {
        ...
        try {
            ...
            dao = UsuarioDAOFactory.getUsuarioDAO("UsuarioDAOJPAImpl");
